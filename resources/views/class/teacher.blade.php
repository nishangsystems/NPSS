        ...
        <div class="card-body">
            ...
            <div class="mg-b-20">
                <div class="row gutters-8 d-flex-column align-items-end">
                        <button type="button" onclick="showAddModal()"  class="btn-md btn-primary text-white">Add Teacher to {{$class->byLocale()->name}}</button>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-danger" onclick="showRemoveModal({{$user->id}})"  ><i
                                            class="fa fa-trash text-orange-peel"></i> Remove From {{$class->byLocale()->name}}</button>
                                        ...
                                        <div class="modal-dialog bg-white" role="document">
                                            <form method="post" class="modal-content" action="{{route('class.teacher.add',$class->id)}}">
                                                ...
                                                <div class="modal-body">
                                                    Remove {{$user->name}}  from {{$class->byLocale()->name}}
                                                </div>
